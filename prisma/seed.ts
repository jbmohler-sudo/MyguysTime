...
export async function seedDatabase() {
  ...
  try {
    // Upsert state payroll rules for all 50 states — idempotent, safe to re-run
    const stateRules = [
      // ── No state income tax — FULL support, 0% withholding ──────────────────
      { stateCode: "AK", stateName: "Alaska",        supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      { stateCode: "FL", stateName: "Florida",       supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      { stateCode: "NH", stateName: "New Hampshire", supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax on wages (dividend/interest tax fully phased out 2025)." },
      { stateCode: "NV", stateName: "Nevada",        supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      { stateCode: "SD", stateName: "South Dakota",  supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      { stateCode: "TN", stateName: "Tennessee",     supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax on wages." },
      { stateCode: "TX", stateName: "Texas",         supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      { stateCode: "WA", stateName: "Washington",    supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding. WA has a capital gains tax but no wage income tax." },
      { stateCode: "WY", stateName: "Wyoming",       supportLevel: "FULL",           hasStateIncomeTax: false, defaultStateWithholdingValue: 0,      notes: "No state income tax withholding." },
      // ── Pennsylvania — FULL support at flat 3.07% ───────────────────────────
      { stateCode: "PA", stateName: "Pennsylvania",  supportLevel: "FULL",           hasStateIncomeTax: true,  defaultStateWithholdingValue: 0.0307, notes: "Pennsylvania flat income tax rate of 3.07%." },
      // ── Massachusetts — FULL support at 5% flat + PFML ──────────────────────
      {
        stateCode: "MA", stateName: "Massachusetts",
        supportLevel: "FULL", hasStateIncomeTax: true,
        hasExtraEmployeeWithholdings: true, extraWithholdingTypes: "PFML",
        defaultStateWithholdingValue: 0.05,
        defaultPfmlEnabled: true, defaultPfmlEmployeeRate: 0.0045,
        notes: "Massachusetts payroll-prep support includes state withholding estimate plus PFML shown as a separate line.",
        disclaimerText: "Massachusetts payroll-prep support includes separate PFML handling. Review all withholding amounts before issuing checks.",
      ...
      // ── Income tax states — PARTIAL_MANUAL, flat-rate estimate ──────────────
      // Rates are reasonable estimates for payroll-prep purposes; verify before issuing checks.
      { stateCode: "AL", stateName: "Alabama",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.05,   notes: "Estimated flat rate ~5%. Verify with Alabama DOR; progressive brackets apply." },
      { stateCode: "AZ", stateName: "Arizona",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.025,  notes: "Arizona flat income tax rate of 2.5% (effective 2023). Verify current rate with ADOR." },
      { stateCode: "AR", stateName: "Arkansas",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.044,  notes: "Estimated ~4.4% top marginal rate. Verify with Arkansas DFA; progressive brackets apply." },
      { stateCode: "CA", stateName: "California",     supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.06,   notes: "Estimated ~6% for mid-range wages. CA progressive brackets vary widely; verify with CDTFA/FTB." },
      { stateCode: "CO", stateName: "Colorado",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.044,  notes: "Colorado flat income tax rate of 4.4%. Verify current rate with CDOR." },
      { stateCode: "CT", stateName: "Connecticut",    supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.05,   notes: "Estimated ~5% for mid-range wages. Verify with Connecticut DRS; progressive brackets apply." },
      { stateCode: "DE", stateName: "Delaware",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.052,  notes: "Estimated ~5.2% for mid-range wages. Verify with Delaware DOF; progressive brackets apply." },
      { stateCode: "GA", stateName: "Georgia",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0549, notes: "Georgia flat income tax rate of 5.49% (2024). Verify current rate with Georgia DOR." },
      { stateCode: "HI", stateName: "Hawaii",         supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.07,   notes: "Estimated ~7% for mid-range wages. Verify with Hawaii DOTAX; progressive brackets apply." },
      { stateCode: "ID", stateName: "Idaho",          supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.058,  notes: "Idaho flat income tax rate of 5.8%. Verify current rate with Idaho State Tax Commission." },
      { stateCode: "IL", stateName: "Illinois",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0495, notes: "Illinois flat income tax rate of 4.95%. Verify current rate with Illinois DOR." },
      { stateCode: "IN", stateName: "Indiana",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0305, notes: "Indiana flat income tax rate of 3.05%. Note: county income taxes may also apply." },
      { stateCode: "IA", stateName: "Iowa",           supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.046,  notes: "Estimated ~4.6% (Iowa reducing to flat rate over time). Verify current rate with Iowa DOR." },
      { stateCode: "KS", stateName: "Kansas",         supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.05,   notes: "Estimated ~5% for mid-range wages. Verify with Kansas DOR; progressive brackets apply." },
      { stateCode: "KY", stateName: "Kentucky",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.045,  notes: "Kentucky flat income tax rate of 4.5%. Verify current rate with Kentucky DOR." },
      { stateCode: "LA", stateName: "Louisiana",      supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.03,   notes: "Louisiana flat income tax rate of 3% (effective 2025). Verify current rate with LDR." },
      { stateCode: "ME", stateName: "Maine",          supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.06,   notes: "Estimated ~6% for mid-range wages. Verify with Maine Revenue Services; progressive brackets apply." },
      { stateCode: "MD", stateName: "Maryland",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.05,   notes: "Estimated ~5% for mid-range wages. Note: local income taxes also apply. Verify with Comptroller of Maryland." },
      { stateCode: "MI", stateName: "Michigan",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0425, notes: "Michigan flat income tax rate of 4.25%. Note: city income taxes may also apply. Verify with Michigan Treasury." },
      { stateCode: "MN", stateName: "Minnesota",      supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.06,   notes: "Estimated ~6% for mid-range wages. Verify with Minnesota DOR; progressive brackets apply." },
      { stateCode: "MS", stateName: "Mississippi",    supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.047,  notes: "Mississippi flat income tax rate of 4.7% (transitioning to flat). Verify current rate with Mississippi DOR." },
      { stateCode: "MO", stateName: "Missouri",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.048,  notes: "Estimated ~4.8% for mid-range wages. Verify with Missouri DOR; progressive brackets apply." },
      { stateCode: "MT", stateName: "Montana",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.069,  notes: "Montana flat income tax rate of 6.9% (effective 2024). Verify current rate with Montana DOR." },
      { stateCode: "NE", stateName: "Nebraska",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.05,   notes: "Estimated ~5% for mid-range wages. Verify with Nebraska DOR; progressive brackets apply." },
      { stateCode: "NJ", stateName: "New Jersey",     supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.055,  notes: "Estimated ~5.5% for mid-range wages. Verify with New Jersey Division of Taxation; progressive brackets apply." },
      { stateCode: "NM", stateName: "New Mexico",     supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.049,  notes: "Estimated ~4.9% for mid-range wages. Verify with New Mexico TRD; progressive brackets apply." },
      { stateCode: "NY", stateName: "New York",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.06,   notes: "Estimated ~6% for mid-range wages. Note: NYC/Yonkers local taxes may also apply. Verify with NYS DTF." },
      { stateCode: "NC", stateName: "North Carolina", supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.045,  notes: "North Carolina flat income tax rate of 4.5%. Verify current rate with NC DOR." },
      { stateCode: "ND", stateName: "North Dakota",   supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.025,  notes: "Estimated ~2.5% for mid-range wages. Verify with North Dakota OTC; low progressive brackets apply." },
      { stateCode: "OH", stateName: "Ohio",           supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.04,   notes: "Estimated ~4% for mid-range wages. Note: municipal income taxes also apply. Verify with Ohio DT." },
      { stateCode: "OK", stateName: "Oklahoma",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.045,  notes: "Estimated ~4.5% for mid-range wages. Verify with Oklahoma OTC; progressive brackets apply." },
      { stateCode: "OR", stateName: "Oregon",         supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.08,   notes: "Estimated ~8% for mid-range wages. Verify with Oregon DOR; progressive brackets apply." },
      { stateCode: "RI", stateName: "Rhode Island",   supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0475, notes: "Estimated ~4.75% for mid-range wages. Verify with Rhode Island Division of Taxation; progressive brackets apply." },
      { stateCode: "SC", stateName: "South Carolina", supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.064,  notes: "South Carolina top flat rate of 6.4% (2024, reducing annually). Verify current rate with SC DOR." },
      { stateCode: "UT", stateName: "Utah",           supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0465, notes: "Utah flat income tax rate of 4.65%. Verify current rate with Utah Tax Commission." },
      { stateCode: "VT", stateName: "Vermont",        supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.066,  notes: "Estimated ~6.6% for mid-range wages. Verify with Vermont DT; progressive brackets apply." },
      { stateCode: "VA", stateName: "Virginia",       supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.0575, notes: "Virginia top marginal rate of 5.75%. Verify with Virginia DT; progressive brackets apply." },
      { stateCode: "WV", stateName: "West Virginia",  supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.065,  notes: "Estimated ~6.5% for mid-range wages. Verify with West Virginia DOR; progressive brackets apply." },
      { stateCode: "WI", stateName: "Wisconsin",      supportLevel: "PARTIAL_MANUAL", hasStateIncomeTax: true, defaultStateWithholdingValue: 0.053,  notes: "Estimated ~5.3% for mid-range wages. Verify with Wisconsin DOR; progressive brackets apply." },
    ];

    for (const rule of stateRules) {
      await prisma.statePayrollRule.upsert({
        where: { stateCode: rule.stateCode },
        update: {
          stateName: rule.stateName,
          supportLevel: rule.supportLevel,
          hasStateIncomeTax: rule.hasStateIncomeTax ?? true,
          hasExtraEmployeeWithholdings: (rule as any).hasExtraEmployeeWithholdings ?? false,
          extraWithholdingTypes: (rule as any).extraWithholdingTypes ?? null,
          defaultStateWithholdingMode: "PERCENTAGE",
          defaultStateWithholdingValue: rule.defaultStateWithholdingValue,
          defaultPfmlEnabled: (rule as any).defaultPfmlEnabled ?? false,
          defaultPfmlEmployeeRate: (rule as any).defaultPfmlEmployeeRate ?? 0,
          notes: rule.notes ?? null,
          disclaimerText: (rule as any).disclaimerText ?? null,
          lastReviewedAt: new Date("2026-04-25T09:00:00"),
          sourceLabel: (rule as any).sourceLabel ?? "Internal payroll-prep baseline",
          sourceUrl: (rule as any).sourceUrl ?? "https://www.irs.gov/",
          isActive: true,
        },
        create: {
